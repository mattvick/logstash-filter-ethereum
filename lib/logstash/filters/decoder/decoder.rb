# code taken from: https://raw.githubusercontent.com/EthWorks/ethereum.rb/master/lib/ethereum/decoder.rb
class Decoder
  ...
  def decode_bytes(value, subtype, start)
    ...
    subtype.nil? ? decode_dynamic_bytes(value, start) : decode_static_bytes(value, subtype, start)
  end
  ...
  private 
    ...
    def bitsize(subtype, default = 256)
      ...
      subtype.nil? ? default : subtype.to_i
    end
